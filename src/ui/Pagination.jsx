...
function Pagination({ numResults }) {
  ...
  const numPages = Math.ceil(numResults / PAGE_RESULTS);
  ...
  return (
    <StyledPagination>
      <P>
        Showing <span>{(currentPage - 1) * PAGE_RESULTS + 1}</span> to
        <span>
          {currentPage === numPages ? numResults : currentPage * PAGE_RESULTS}
        </span>
